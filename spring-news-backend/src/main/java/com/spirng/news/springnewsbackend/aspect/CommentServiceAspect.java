...
public class CommentServiceAspect {
    ...
    @Before("execution(public * com.spirng.news.springnewsbackend.service.CommentService.*(..))")
    ...
    @After("execution(public * com.spirng.news.springnewsbackend.service.CommentService.*(..))")
